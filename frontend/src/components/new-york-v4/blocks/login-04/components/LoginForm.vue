    ...
    <Card class="overflow-hidden p-0 border-white/60 shadow-2xl shadow-purple-500/10">
      <CardContent class="grid p-0 md:grid-cols-2">
          ...
          <FieldGroup>
            <div class="flex flex-col items-center gap-2 text-center">
              ...
              <p class="text-gray-500 text-sm max-w-xs">
                Your clubs missed you. Sign in and see what's happening.
              </p>
            </div>
            <Field>
            ...
            <Field>
              <div class="flex items-center">
                ...
                <a
                  href="#"
                  class="ml-auto text-sm underline-offset-2 hover:underline text-gray-400 hover:text-gray-600"
                >
                  forgot? 🙃
                </a>
              </div>
            ...
            <Field>
              ...
              <Button type="button" class="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white shadow-lg shadow-purple-500/30 border-0" :disabled="loading" @click="handleLogin">
            ...
            <div class="text-center text-sm text-gray-500">
              New here? <RouterLink to="/signup" class="text-purple-600 font-bold hover:text-purple-700">Join a club →</RouterLink>
            </div>
          </FieldGroup>
        </form>
        <div class="bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 relative hidden md:flex flex-col items-center justify-center p-8 text-white">
          ...
          <h3 class="text-xl font-bold text-center mb-2">Your club dashboard awaits</h3>
          <p class="text-white/80 text-sm text-center max-w-xs">Events, members, tasks — all in one place. No spreadsheets required.</p>
          <div class="mt-6 flex -space-x-2">
            <div class="w-8 h-8 rounded-full border-2 border-white/50 bg-white/20 flex items-center justify-center text-xs font-bold">S</div>
            <div class="w-8 h-8 rounded-full border-2 border-white/50 bg-white/20 flex items-center justify-center text-xs font-bold">M</div>
            <div class="w-8 h-8 rounded-full border-2 border-white/50 bg-white/20 flex items-center justify-center text-xs font-bold">T</div>
            <div class="w-8 h-8 rounded-full border-2 border-white/50 bg-white/20 flex items-center justify-center text-xs font-bold">+3</div>
          </div>
        </div>
      </CardContent>
    </Card>
